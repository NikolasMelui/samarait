...
$(document).ready(function(){console.log("WOW!!!"),$(".masthead").visibility({once:!1,onBottomPassed:function(e){$(".fixed.menu").transition("fade in")},onBottomPassedReverse:function(){$(".fixed.menu").transition("fade out")}}),$(".ui.sidebar").sidebar("attach events",".toc.item"),function(e){e.forEach(function(e){for(var i=$(e)[0],n=0;n<i.childNodes.length;n++)i.childNodes[n].pathname==window.location.pathname?i.childNodes[n].className+=" active":i.childNodes[n].className})}([".ui.large.secondary.inverted.pointing.menu",".ui.container",".ui.vertical.inverted.sidebar.menu.left"])});
//# sourceMappingURL=data:application/json;charset=utf8;base64,
